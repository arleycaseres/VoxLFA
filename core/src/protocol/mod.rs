...
pub use dsp::{
    ...
    DynamicEqBandParams, DynamicEqParams, EqBand, EqBandKind, FeedbackSuppressorParams,
    MusicalNote, MusicalScale, NoiseGateParams, PitchCorrectionParams, PresetId, PresetInfo,
    ReverbMode, ReverbParams, SaturatorMode, SaturatorParams,
};
pub use event::{
